    ...
    http:
      ...
      routers:
        ...
        homepage-health-requests-router:
          rule: "Host(`${domain}`) && Path(`/health/requests`)"
        ...
        homepage-health-refinery-router:
          rule: "Host(`${domain}`) && Path(`/health/refinery`)"
