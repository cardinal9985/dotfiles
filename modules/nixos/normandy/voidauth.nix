...
in
{
  ...
  system.activationScripts.voidauth-theme = ''
    ...
    # custom templates drop the .default suffix to override.
    for type in admin_notification approved email_verification invitation reset_password test_notification; do
